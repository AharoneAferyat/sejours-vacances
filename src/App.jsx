  ...
  return (
    <div className="app-shell">
      ...
      <Header
        ...
        onOpenVoyageurs={() => setShowVoyageurs(true)} onOpenFAQ={() => setTab('faq')}
      ...
      <div className="app-main">
        ...
        <div className="app-content">
          ...
          {tab === 'faq' && (
            <div className="content-pane">
              <FAQ onClose={() => setTab('dashboard')} inline={true} />
            </div>
          )}
